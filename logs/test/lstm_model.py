...
class PCB_Effi_LSTM(nn.Module):
    def __init__(self, model):
        ...
        for i in range(self.part):
            ...
            setattr(self, name, ClassBlock(1*640, self.class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))

        for i in range(self.part-1):
            name = 'classifierB'+str(i)
            setattr(self, name, ClassBlock(2*640, self.class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))
        ...
        for i in range(self.part-2):
            ...
            setattr(self, name, ClassBlock(3*640, self.class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))
        ...
        for i in range(self.part-3):
            ...
            setattr(self, name, ClassBlock(4*640, self.class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))
